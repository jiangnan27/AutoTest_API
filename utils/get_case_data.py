...
mode = eval(ReadIni().get_ini_value(CASE_INI, 'MODE', 'mode'))
...
class GetCaseData:
    ...
    def get_case_data(self):
        ...
        for old_data_01 in old_case_data:
            # print(old_data_01)
            if 'my_get_csv' in str(old_data_01):  # 看看是不是需要开启csv参数化
